...
public class HomePage extends BasePage {
	...
	public HomePage clicarSingIN() {
		...
		//Log.info("Elemento de nome 'sign_in_btnundefined' encontrado string passada");
		return this;
	}
	...
	public CadastroPage clicarNewAccount() throws InterruptedException {
		...
		driver.findElement(By.cssSelector("body.ng-scope:nth-child(2) login-modal:nth-child(3) div.PopUp div:nth-child(1) div.login.ng-scope > a.create-new-account.ng-scope:nth-child(6)")).sendKeys(Keys.ENTER);
